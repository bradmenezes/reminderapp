...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'scheduler_schedule', 'day_of_week', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Schedule.message'
        db.alter_column(u'scheduler_schedule', 'message', self.gf('django.db.models.fields.TextField')(max_length=150))
